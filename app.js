...
const VF_PROJECT = {
  ...
  'talking-prospects': '689b3ef19f2f40a7aa3ea834',
...
function renderLearningPath(){
  ...
  const EVERYDAY = ['complaining','suggestions-advice','shopping-enquiries','hotel','gossip-personal','small-talks','ordering-food','telephone-talk','making-appointment','travel'];
